...
### "커맨드 팔레트를 열라는게 무슨 말이지?"라고 생각하시는 분도 있을 것 같아 스크린샷을 첨부합니다(3장).
...
## 1.4 pip를 통한 패키지 설치
마지막으로, 파이썬 자체에 기능을 추가해주기 위해서 라이브러리를 설치하겠습니다.  
크롬을 통해 인터넷에 접속하기 위해 Selenium을 설치합니다. [관련 링크(티스토리 블로그)](http://shaeod.tistory.com/915)
